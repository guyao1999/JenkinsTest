...
public class MyImageInfo {
    ...
    //CompressionAlgorithm类用于存放图片的图片格式（压缩算法）
    ...
    private static final Logger LOGGER = Logger.getLogger(MyImageInfo.class.getName());
    ...
    public MyImageInfo(final String formatDetails, final int bitsPerPixel,
